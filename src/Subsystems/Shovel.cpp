	...
	Subsystem("Shovel")
{
	...
	m_pWidthSolenoid0 = new OzSolenoid(RobotMap::Shovel::shovelGrabSol[0], RobotMap::Shovel::shovelGrabSol[1]);
	//m_pWidthSolenoid1 = new OzSolenoid(RobotMap::Shovel::shovelCollectSol[0], RobotMap::Shovel::shovelCollectSol[1]);
...
Shovel::~Shovel()
{
	...
	SAFE_DELETE(m_pWidthSolenoid0);
	//SAFE_DELETE(m_pWidthSolenoid1);
